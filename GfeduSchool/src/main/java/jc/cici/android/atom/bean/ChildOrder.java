...
public class ChildOrder {
    ...
    public String getOrder_BuyType() {
        return Order_BuyType;
    }

    public void setOrder_BuyType(String order_BuyType) {
    ...
    public void setClassType(ClassTypeBean classType) {
        ClassType = classType;
    }

    public ArrayList<PackageProduct> getPackageProductList() {
        return PackageProductList;
    }

    public void setPackageProductList(ArrayList<PackageProduct> packageProductList) {
        PackageProductList = packageProductList;
    }

    public ChildExpress getExpress() {
        return Express;
    }

    public void setExpress(ChildExpress express) {
        Express = express;
    }
}
