...
public class ScoreProgressBar extends View {
    ...
    public ScoreProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundColor = mTypedArray.getColor(
                R.styleable.RoundProgressBar_roundColor, Color.parseColor("#d3d9e2"));
        roundProgressColor = mTypedArray.getColor(
                R.styleable.RoundProgressBar_roundProgressColor, Color.parseColor("#dd5555"));
        textColor = mTypedArray.getColor(
                R.styleable.RoundProgressBar_textColor,
                Color.parseColor("#333333"));
        textSize = mTypedArray.getDimension(
                R.styleable.RoundProgressBar_textSize, 88);
...
//        // 画圆弧
        canvas.drawArc(new RectF(10, 10, radius * 2, radius * 2), 135,
                270, false, paint);
        Log.e("log", centre + "");
        ...
        RectF oval = new RectF(10, 10, centre
        ...
        switch (style) {
            case STROKE: {
                ...
                canvas.drawArc(oval, 135, 225 * progress / max, false, paint); // 根据进度画圆弧
                break;
            }
            case FILL: {
                paint.setAntiAlias(true); // 消除锯齿
                ...
                if (progress != 0)
                    canvas.drawArc(oval, 135, 225 * progress / max, true, paint); // 根据进度画圆弧
                break;
            }
        }
