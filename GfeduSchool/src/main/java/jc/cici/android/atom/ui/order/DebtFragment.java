...
public class DebtFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.debtOrder.refresh".equals(intent.getAction())) {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        adapter = new AllOrderRecyclerAdapter(mCtx, mData, 3);
        ...
        filter.addAction("com.debtOrder.refresh");
