...
public class LiveContent {
    ...
    // 最近直播
    private ArrayList<LateContent> LastestLive;
    // 最近直播数量
    private int LastestLiveCount;
    // 热门直播
    private ArrayList<HotContent> HotLive;
    // 热门直播数量
    private int HotLiveCount;
    // 系列直播
    private ArrayList<SerContent> SeriesLive;
    // 系列直播数量
    private int SeriesLiveCount;
    // 历史回放
    private ArrayList<Content> ExpiredLive;
    // 历史回放数量
    private int ExpiredLiveCount;
    private ArrayList<LiveAds> AdList;
    // 广告数量
    private int AdCount;

    public ArrayList<LiveAds> getAdList() {
        return AdList;
    }

    public void setAdList(ArrayList<LiveAds> adList) {
        AdList = adList;
    }
    ...
    public ArrayList<LateContent> getLastestLive() {
        return LastestLive;
    }

    public void setLastestLive(ArrayList<LateContent> lastestLive) {
        LastestLive = lastestLive;
    }

    public int getLastestLiveCount() {
        return LastestLiveCount;
    }

    public void setLastestLiveCount(int lastestLiveCount) {
        LastestLiveCount = lastestLiveCount;
    }

    public ArrayList<HotContent> getHotLive() {
        return HotLive;
    }

    public void setHotLive(ArrayList<HotContent> hotLive) {
        HotLive = hotLive;
    }

    public int getHotLiveCount() {
        return HotLiveCount;
    }

    public void setHotLiveCount(int hotLiveCount) {
        HotLiveCount = hotLiveCount;
    }

    public ArrayList<SerContent> getSeriesLive() {
        return SeriesLive;
    }

    public void setSeriesLive(ArrayList<SerContent> seriesLive) {
        SeriesLive = seriesLive;
    }

    public int getSeriesLiveCount() {
        return SeriesLiveCount;
    }

    public void setSeriesLiveCount(int seriesLiveCount) {
        SeriesLiveCount = seriesLiveCount;
    }

    public ArrayList<Content> getExpiredLive() {
        return ExpiredLive;
    }

    public void setExpiredLive(ArrayList<Content> expiredLive) {
        ExpiredLive = expiredLive;
    }

    public int getExpiredLiveCount() {
        return ExpiredLiveCount;
    }

    public void setExpiredLiveCount(int expiredLiveCount) {
        ExpiredLiveCount = expiredLiveCount;
    }
    ...
    public static class LateContent {
        // 1:系列直播 2：正常直播
        private int Class_Form;
        // 直播id
        private int Class_PKID;
