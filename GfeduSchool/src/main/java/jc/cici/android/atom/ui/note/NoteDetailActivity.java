...
public class NoteDetailActivity extends BaseActivity implements WiperSwitch.OnChangedListener {
                        ...
                        new Subscriber<CommonBean<NoteDetailsBean>>() {
                            ...
                            public void onNext(CommonBean<NoteDetailsBean> noteDetailsBeanCommonBean) {
                                if (100 == noteDetailsBeanCommonBean.getCode()) {
                                    ...
                                    // 记录人名称
                                    record_txt.setText("记录人："+ToolUtils.strReplaceAll(info.getS_NickName()));
                                    if (null != video) {
                                        //获取视频名称
                                        ...
                                        if (!"".equals(videoName) && videoName.length() > 0) {
                                            ...
                                            relation_layout.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    String videoId = String.valueOf(video.getPKID());
                                                    String StudyKey = video.getVideo_StudyKey();
                                                    String title = video.getVNAME();
    ...
    private void initView() {
        ...
        if (1 == key) { // 我的笔记
            ...
            wiperSwitch.setWidthHeight(width / 2 - 450, height / 5 - 150);
        } else { // 大家的笔记
    ...
    void Onclick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.register_txt: // 删除按钮
                Retrofit retrofit2 = RetrofitOKManager.getinstance().doBaseRetrofit(Global.BASE_URL);
                HttpPostService httpPostService2 = retrofit2.create(HttpPostService.class);
                RequestBody body2 = commRequest();
                Observable<CommonBean> observable = httpPostService2.getDelNotesInfo(body2);
                observable.subscribeOn(Schedulers.io())
                        .unsubscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(
                                new Subscriber<CommonBean>() {
                                    ...
                                    public void onNext(CommonBean commonBean) {
                                        if (100 == commonBean.getCode()) {
                                            SweetAlertDialog mDialog = new SweetAlertDialog(baseActivity, SweetAlertDialog.WARNING_TYPE);
