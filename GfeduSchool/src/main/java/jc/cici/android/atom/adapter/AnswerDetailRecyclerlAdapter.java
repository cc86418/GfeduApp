    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        switch (itemType) {
            case FROM_TO_TYPE: // 其他用户
                ...
                // 设置角色
                if (0 == mItems.get(position).getRoleType()) {
                    holder.role_txt.setVisibility(View.GONE);
                } else if (1 == mItems.get(position).getRoleType()) {
                    holder.role_txt.setText("助教");
                    holder.role_txt.setVisibility(View.VISIBLE);
                } else if (2 == mItems.get(position).getRoleType()) {
                    holder.role_txt.setText("班主任");
                    holder.role_txt.setVisibility(View.VISIBLE);
                }

                // 设置内容

//                if("".equals(mItems.get(position).getContent())){
//                    holder.bubbleText_from_layout.setVisibility(View.GONE);
//                }else{
//                    holder.bubbleText_from_layout.setVisibility(View.VISIBLE);
                // 设置内容
                contentSetting(holder.bubbleFrom_txt, position, holder.bubbleText_from_layout);
//                }
                if ("".equals(mItems.get(position).getImageUrl())) {
            ...
            case SEND_TO_TYPE:// 当前用户
                ...
                // 设置内容
//                if("".equals(mItems.get(position).getContent())){
//                    holder.bubbleText_layout.setVisibility(View.GONE);
//                }else{
//                    holder.bubbleText_layout.setVisibility(View.VISIBLE);
                // 设置内容
                contentSetting(holder.bubble_txt, position, holder.bubbleText_layout);
//                }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            ...
            bubbleText_from_layout = (RelativeLayout) itemView.findViewById(R.id.bubbleText_from_layout);
            ...
            bubbleText_layout = (RelativeLayout) itemView.findViewById(R.id.bubbleText_layout);
    ...
    private void contentSetting(TextView tv, int position, RelativeLayout ll) {
        {
            boolean b = true;
            if (position > 0) {
