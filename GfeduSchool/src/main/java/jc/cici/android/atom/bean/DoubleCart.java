...
public class DoubleCart {
    ...
    private ArrayList<ChildCart> List;
    ...
    public void setPackage(PackageBean aPackage) {
        Package = aPackage;
    }

    public ArrayList<ChildCart> getList() {
        return List;
    }

    public void setList(ArrayList<ChildCart> list) {
        List = list;
    }
