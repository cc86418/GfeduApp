...
public class UnPaidFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.unpaidOrder.refresh".equals(intent.getAction())) {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        adapter = new AllOrderRecyclerAdapter(mCtx, mData, 2);
        ...
        filter.addAction("com.unpaidOrder.refresh");
