...
public class ExpiredLiveStatusSection extends StatusSection {

    private Context mCtx;
    private ArrayList<LiveContent.Content> mExpredLiveList;
    // 当前项目id
    ...
    public ExpiredLiveStatusSection(Context context, ArrayList<LiveContent.Content> expredLive, int projectId, String title, int flag) {
        super(R.layout.item_title_live, R.layout.item_section_content_live);
        this.mCtx = context;
        this.mExpredLiveList = expredLive;
    ...
    public int getContentItemsTotal() {
        return null != mExpredLiveList ? mExpredLiveList.size() : 0;
    }
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        LiveContent.Content seriesContent = mExpredLiveList.get(position);
        // 直播课程背景图片
        ...
        itemViewHolder.product_course_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 获取班级id
                int classPkID = mExpredLiveList.get(position).getClass_PKID();
                // 获取系列直播or普通直播
                int classFrom = mExpredLiveList.get(position).getClass_Form();
                switch (classFrom) {
                    case 1: // 系列直播
...
//                        norBundle.putInt("Product_PKID", classPkID);
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder) {
        ...
        headerHolder.lineImg.setBackgroundResource(R.drawable.icon_history);
        headerHolder.headerName_txt.setText("精彩回顾");
