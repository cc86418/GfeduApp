                        ...
                        new Subscriber<UserInfo>() {
                            ...
                            public void onNext(final UserInfo userInfo) {
                                if ("100".equals(userInfo.getCode())) { // 登录成功
                                    ...
                                    if (0 == lastLoginSID) { // 无绑定设备信息
                                        if (0 == status) { // 无绑定记录
                                            ...
                                            ensureBtn.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    // 提示绑定设备
                                                    bindDeiver(userInfo.getBody().getS_PassWord(), userInfo.getBody().getS_Name(), mDialog, userInfo.getBody());
                                                }
                                            });
                                    ...
                                    Toast.makeText(FastLoginActivity.this,userInfo.getMessage() , Toast.LENGTH_SHORT).show();
                                }
                            }
