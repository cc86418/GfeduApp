    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                } else if ("com.jc.addnote".equals(intent.getAction())  // 正常添加笔记
                        || "com.jc.noteChange".equals(intent.getAction()) // 全部解析添加笔记
                        || "com.jc.wroNoteChange".equals(intent.getAction())) { // 错题解析添加笔记
                            ...
                            new Subscriber<CommonBean<NoteBean>>() {
                                ...
                                public void onNext(CommonBean<NoteBean> noteBeanCommonBean) {
                                    if (100 == noteBeanCommonBean.getCode()) {
                                        emptyView.setVisibility(View.GONE);
                                        ArrayList<Note> refreshList = new ArrayList<Note>();
                                        refreshList = noteBeanCommonBean.getBody().getNotesList();
            ...
            observable.subscribeOn(Schedulers.io())
                    ...
                    .subscribe(
                            new Subscriber<CommonBean<NoteBean>>() {
                                ...
                                public void onNext(CommonBean<NoteBean> noteBeanCommonBean) {
                                    if (100 == noteBeanCommonBean.getCode()) {
                                        ArrayList<Note> moreList = new ArrayList<>();
