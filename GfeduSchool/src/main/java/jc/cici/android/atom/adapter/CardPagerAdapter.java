...
public class CardPagerAdapter extends PagerAdapter implements CardAdapter {
    ...
    private List<AutoCardView> mViews;
    ...
    public CardPagerAdapter(Context context, int classID, String className) {
        mCtx = context;
        mData = new ArrayList<>();
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        AutoCardView cardView = (AutoCardView) view.findViewById(R.id.cardView);
        if (mBaseElevation == 0) {
    ...
    private void bind(CardItem cardItem, View view, int position) {
        ...
        // 科目名字
        TextView icon_form_Txt = (TextView) view.findViewById(R.id.icon_form_Txt);
        // 课表图片
        ...
        if (materialFlag == 1) { // 已启用状态
            if ("面授".equals(cardItem.getStageType())) {
                ...
                goClickableMat_Img.setBackgroundResource(R.drawable.icon_goclick_zb);
                goClickableMat_Img.setEnabled(true);
                goClickableMat_Img.setClickable(true);
            } else if ("在线".equals(cardItem.getStageType())) {
                icon_material_Imag.setBackgroundResource(R.drawable.icon_material_zx);
                goClickableMat_Img.setBackgroundResource(R.drawable.icon_goclick_zx);
                goClickableMat_Img.setEnabled(true);
                goClickableMat_Img.setClickable(true);
            }
        ...
        switch (status) {
            ...
            case 0: // 未开始状态
                ...
                icon_ques_Imag.setBackgroundResource(R.drawable.icon_question_normal);
                icon_note_Imag.setBackgroundResource(R.drawable.icon_note_normal);
                icon_material_Imag.setBackgroundResource(R.drawable.icon_material_normal);
                icon_form_Imag.setBackgroundResource(R.drawable.icon_normal);
                ...
                switch (v.getId()) {
                    case R.id.goClickableFrom_Img: // 课表按钮
                        ...
                        if ("在线".equals(mData.get(position).getStageType())) {
                            ...
                            // 笔记解锁状态
                            bundle.putString("StageNote", String.valueOf(mData.get(position).getStageNote()));
                            // 问题解锁状态
                            bundle.putString("StageProblem", String.valueOf(mData.get(position).getStageProblem()));
                            // 资料解锁状态
                            bundle.putString("StageInformation", String.valueOf(mData.get(position).getStageInformation()));
                            ...
                            bundle.putString("StageName", String.valueOf(mData.get(position).getStageName()));
                            it.putExtras(bundle);
                            mCtx.startActivity(it);
                        } else if ("面授".equals(mData.get(position).getStageType())) {
                            Intent it = new Intent(mCtx, CourseFormActivity.class);
                            Bundle bundle = new Bundle();
                            bundle.putString("className", mClassName);
                            ...
                            // 笔记解锁
                            bundle.putInt("stageNote", mData.get(position).getStageNote());
                            // 问题解锁
                            bundle.putInt("stageProblem", mData.get(position).getStageProblem());
                            // 资料解锁
                            bundle.putInt("stageInformation", mData.get(position).getStageInformation());
                            it.putExtras(bundle);
                            mCtx.startActivity(it);
                        } else if ("直播".equals(mData.get(position).getStageType())) {
                            Intent it = new Intent(mCtx, CourseFormActivity.class);
                            Bundle bundle = new Bundle();
                            bundle.putString("className", mClassName);
                            bundle.putString("titleName", mData.get(position).getStageName());
                    ...
                    case R.id.goClickableQues_Img: // 问题按钮
                        ...
                        quesBundle.putString("className", mClassName);
                    ...
                    case R.id.goClickableNote_Img: // 笔记按钮
                        ...
                        noteBundle.putString("className", mClassName);
                    ...
                    case R.id.goClickableMat_Img: // 资料按钮
                        Toast.makeText(mCtx, "资料下载请移至电脑端", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
