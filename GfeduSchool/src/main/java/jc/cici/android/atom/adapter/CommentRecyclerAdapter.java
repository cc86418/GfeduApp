...
public class CommentRecyclerAdapter extends BaseRecycleerAdapter<Comment, CommentRecyclerAdapter.MyHolder> {

    private Activity mCtx;
    private ArrayList<Comment> mItems;
    private Handler mHandler;

    public CommentRecyclerAdapter(Activity context, ArrayList<Comment> items, Handler handler) {
        super(context, items);
        this.mCtx = context;
        this.mItems = items;
    ...
    @Override
    public void onBindViewHolder(final MyHolder holder, Comment item, final int position) {
        // 用户图像
