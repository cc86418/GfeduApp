...
public class OrganExamAdapter extends BaseRecycleerAdapter<TestPaperBean.TestPaperInfo, OrganExamAdapter.MyHolder> {

    private Activity mCtx;
    private ArrayList<TestPaperBean.TestPaperInfo> mItems;

    public OrganExamAdapter(Context context, List<TestPaperBean.TestPaperInfo> items) {
        super(context, items);
        this.mCtx = (Activity) context;
        this.mItems = (ArrayList<TestPaperBean.TestPaperInfo>) items;
    }
    ...
    @Override
    public void onBindViewHolder(MyHolder holder, final TestPaperBean.TestPaperInfo item, final int position) {
        ...
        if (0 == status) { // 未提交情况
            ...
            holder.againExam_layout.setBackgroundResource(R.drawable.bg_history_organ_btn);
            holder.againExam_txt.setText("开始做题");
            holder.againExam_txt.setTextColor(Color.parseColor("#666666"));
            holder.reportExam_txt.setVisibility(View.GONE);
        }
