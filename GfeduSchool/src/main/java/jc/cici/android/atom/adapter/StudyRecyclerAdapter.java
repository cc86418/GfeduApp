...
public class StudyRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof Holder) {
            ...
            if (1 == item.getClassIsGift()) {
                ((Holder) viewHolder).giveFlag_Img.setVisibility(View.VISIBLE);
            } else if (0 == item.getClassIsGift()) {
                ((Holder) viewHolder).giveFlag_Img.setVisibility(View.GONE);
            }
            ...
            switch (status) {
                case 1: // 正常情况
                    ...
                    ((Holder) viewHolder).lockImg.setVisibility(View.GONE);
                ...
                case -2: // 锁定情况
                    ...
                    ((Holder) viewHolder).time_Item_Txt.setTextColor(Color.parseColor("#c8c8c8"));
                    ((Holder) viewHolder).type_Item_Txt.setTextColor(Color.parseColor("#c8c8c8"));
                    ((Holder) viewHolder).hint_Item_txt.setText(ToolUtils.strReplaceAll(item.getClassStatusName()));
                    ((Holder) viewHolder).lockImg.setVisibility(View.VISIBLE);
                    ((Holder) viewHolder).noSelect_Img.setVisibility(View.VISIBLE);
                    break;
                default:
