...
public class CourseSearchRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CourseSearchRecyclerAdapter(Context context, ArrayList<Product> items) {
    ...
    private void bindTyPeNormalHolder(TypeNormalHolder holder, int position) {
        ...
        // 学习人数
        holder.studyCount_txt.setText("学习人数：" + mData.get(position).getProduct_StudyNum());
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_NORMAL:
                itemView = LayoutInflater.from(mCtx).inflate(R.layout.item_course_search, parent, false);
