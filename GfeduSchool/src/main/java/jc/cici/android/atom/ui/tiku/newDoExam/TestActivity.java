...
public class TestActivity extends BaseActivity {
    ...
    private ArrayList<TestBean.QuestionTest> datas = new ArrayList<>();
    //
...
//                            mTime = "00:00";
    ...
    private void initData() {
        ...
        Observable<CommonBean<TestBean>> observable = httpPostService.getPaperquesInfo(body);
        observable.subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<CommonBean<TestBean>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(CommonBean<TestBean> testBeanCommonBean) {
                        if (100 == testBeanCommonBean.getCode()) {
//                            paperId = testBeanCommonBean.getBody().getPaperId();
                            title = testBeanCommonBean.getBody().getTpaperName();
                            // 获取总时长
                            totalTime = testBeanCommonBean.getBody().getTpaperTime();
                            // 获取上次做题时间
                            int lastDoTime = testBeanCommonBean.getBody().getLastDoTime();
                            if (lastDoTime > 0) {
                            ...
                            // 获取试卷列表
                            ArrayList<TestBean.QuestionTest> mList = testBeanCommonBean.getBody().getPaperQuesCardList();
...
//                                    bundle.putInt("answerType", answerType);
                                ...
                                // 上次做题位置
                                int jumpStr = testBeanCommonBean.getBody().getLastDoNo();
                            ...
                            Toast.makeText(baseActivity, testBeanCommonBean.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int arg0) {
            ...
            // 显示当前做题位置
            register_txt.setText((arg0 + 1) + "/" + datas.size());
            register_txt.setTextColor(Color.parseColor("#333333"));
            // 判断是否收藏
    ...
    private void goToCardAnswerActivity() {
        ...
        cardAswerIntent.putExtra("time", TestActivity.getCurrentTime());
