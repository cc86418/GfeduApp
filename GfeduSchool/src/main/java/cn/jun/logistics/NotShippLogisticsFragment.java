...
public class NotShippLogisticsFragment extends Fragment {
    //工具
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mView == null) {
            mView = inflater.inflate(R.layout.notshipplogistics_layout, container, false);
            initView(mView);
//            initData();
        } else {
...
//                if (!"".equals(CustomList) && null != CustomList) {
                ...
                for (int i = 0; i < 25; i++) {
                    ...
                    customBean.Product_Name = "a -- "+i;
                    customBean.Product_Intro = "b -- "+i;
                    customBean.Product_IntroName = "c -- "+i;
...
//                if (mAdapter.getItemCount() > 30 && isFailed) {
                if (1 == isEndList && isFailed) {
                    ...
                    for (int i = 26; i < 50; i++) {
                        customBean = new CustomBean();
                        customBean.Product_Name = "1 -- " + i;
                        customBean.Product_Intro = "2 -- " + i;
                        customBean.Product_IntroName = "3 -- " + i;
                        CustomList.add(customBean);
                    }
