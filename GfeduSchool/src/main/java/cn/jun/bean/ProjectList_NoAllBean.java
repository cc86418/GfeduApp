...
public class ProjectList_NoAllBean implements Serializable {
    private String Code;
    ...
    public class Body {
        ...
        public ArrayList<ProjectList_NoAllBean.Body.ProjectList> getProjectList() {
            return ProjectList;
        }

        public void setProjectList(ArrayList<ProjectList_NoAllBean.Body.ProjectList> projectList) {
    ...
    public ProjectList_NoAllBean.Body getBody() {
        return Body;
    }

    public void setBody(ProjectList_NoAllBean.Body body) {
        Body = body;
    }
}
