...
public class GetMyLiveBean {
    ...
    public class Body {
        ...
        public class List {
            ...
            public ArrayList<GetMyLiveBean.Body.List.ScheduleList> getScheduleList() {
                return ScheduleList;
            }

            public void setScheduleList(ArrayList<GetMyLiveBean.Body.List.ScheduleList> scheduleList) {
        ...
        public ArrayList<GetMyLiveBean.Body.List> getList() {
            return List;
        }

        public void setList(ArrayList<GetMyLiveBean.Body.List> list) {
            List = list;
        }
    }
    ...
    public GetMyLiveBean.Body getBody() {
        return Body;
    }

    public void setBody(GetMyLiveBean.Body body) {
        Body = body;
    }
}
