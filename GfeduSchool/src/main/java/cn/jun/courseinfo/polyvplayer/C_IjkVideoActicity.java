package cn.jun.courseinfo.polyvplayer;
...
//    private PolyvPlayerFirstStartView playerFirstStartView = null;
    ...
    // videoview的容器
    private C_VideoViewContainer rl = null;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            AlertDialog.Builder builder = new AlertDialog.Builder(C_IjkVideoActicity.this);
            builder.setTitle("提示");
    ...
    public static Intent newIntent(Context context, PlayMode playMode, PlayType playType, String value,
        ...
        Intent intent = new Intent(context, C_IjkVideoActicity.class);
    ...
    public static void intentTo(Context context, PlayMode playMode, PlayType playType, String value, boolean startNow, String title) {
        context.startActivity(newIntent(context, playMode, playType, value, startNow, title));
    }

    public static void intentTo(Context context, PlayMode playMode, PlayType playType, String value,
                                boolean isMustFromLocal, Video.HlsSpeedType hlsSpeedType, boolean startNow, String title) {
        context.startActivity(newIntent(context, playMode, playType, value, isMustFromLocal, hlsSpeedType, startNow, title));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_video_small2);
        ...
        rl = (C_VideoViewContainer) findViewById(R.id.rl);
...
//                            mDanmakuView.resume();
        ...
        mediaController = new C_MediaController(this, false, C_IjkVideoActicity.this, title);
        mediaController.setIjkVideoView(videoView);
        mediaController.setAnchorView(videoView);
        mediaController.setInstantSeeking(false);
        videoView.setMediaController(mediaController);
        // 设置切屏事件
        mediaController.setOnBoardChangeListener(new C_MediaController.OnBoardChangeListener() {
...
//            }
    ...
    public void changeToLandscape() {
        ...
        int[] wh = ScreenTool.getNormalWH(this);
//        RelativeLayout.LayoutParams p = new RelativeLayout.LayoutParams(wh[-1], wh[-1]);
