...
public class C_MediaController extends IjkBaseMediaController {
    //标题文字
...
//    }
    ...
    public C_MediaController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = this;
        mFromXml = true;
     ...
     */
    public C_MediaController(Context context, boolean isUsePreNext, Activity activity,
                             String titleName) {
        super(context);
    ...
    protected View makeControllerView() {
        mRoot = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE))
                .inflate(R.layout.c_ijkmedia_controller, this);
        return mRoot;
    }
    ...
    protected void initControllerView(View v) {
        ...
        // 倍速
        C_SpeedButton speedButton = (C_SpeedButton) findViewById(R.id.speed);
