...
public class MyReadSwipeAdapter extends BaseAdapter {
    private Activity context;
    private ArrayList<GetNotifybyIsRead> mList;

    public MyReadSwipeAdapter(Activity context, ArrayList<GetNotifybyIsRead> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, R.layout.notifi_read_item, null);
