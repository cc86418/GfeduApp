package cn.jun.indexmain.ImageSlideshow;
...
public class ImageSlideshow extends FrameLayout {
    ...
    private void initView() {
        ...
        llDot = (LinearLayout) findViewById(R.id.ll_dott);
    }
    ...
    // 设置完后最终提交
    public void commit() {
        Log.i("ImageSlideshow ___ ", "== commit ==");
...
//            view.setBackgroundResource(R.drawable.shape_point_normal);
        ...
        llDot.getChildAt(0).setBackgroundResource(R.drawable.dot_selected_two);
//        llDot.getChildAt(0).setBackgroundResource(R.drawable.shape_point_selected);
    ...
    private void starPlay() {
        Log.i("ImageSlideshow ___ ", "== starPlay ==");
        // 如果少于2张就不用自动播放了
        if (count < 2) {
            isAutoPlay = false;
        } else {
