...
public abstract class BaseRecycleerAdapter<DATA, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public BaseRecycleerAdapter(Context context, Map<Integer, ArrayList<DATA>> items, int position) {
        this.context = context;
        this.items = items.get(position);
    }
...
//     * 添加一个数据集
//     */
//    public void addItems(Map<Integer, List<DATA>> items) {
//        if (items != null) {
