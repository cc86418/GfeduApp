...
import static jc.cici.android.R.id.biji;
import static jc.cici.android.R.id.wenda;


public class VerticalScreenActivity extends Activity implements View.OnClickListener, XListView.IXListViewListener {
    private BarrageView barrageView;
    private int SID;
    private String UserTel;
    private String S_RealName;
    public static VerticalScreenActivity VerticalAc = null;
...
//        xgl_ImageView.setOnClickListener(this);
        ...
        wenda_btn = (RelativeLayout) findViewById(wenda);
        biji_btn = (RelativeLayout) findViewById(biji);
        ...
        wendaListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent wendaIntent = new Intent(VerticalScreenActivity.this, QuestionDetailActivity.class);
                ...
                bundle.putString("StageProblemStatus", StageProblemStatus);
                bundle.putString("StageInformationStatus", StageInformationStatus);
        ...
        bijiListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int isUser = Integer.parseInt(isUserS);
                Intent bijiIntent = new Intent(VerticalScreenActivity.this, NoteDetailActivity.class);
                Bundle bundle = new Bundle();
                ...
                bundle.putString("StageNoteStatus", StageNoteStatus);
                bundle.putString("StageInformationStatus", StageInformationStatus);
...
//                }
        ...
        videoView.setOnPlayPauseListener(new IjkVideoView.OnPlayPauseListener() {
            ...
            public void onCompletion() {
                ...
                // 播放完成，上传学习进度
                if (httpUtils.isNetworkConnected(VerticalScreenActivity.this)) {
        ...
        mediaController = new VerticalMediaController(VerticalScreenActivity.this, true, downsubjectName, StageProblemStatus, StageNoteStatus, StageInformationStatus);
...
//        @SuppressLint("NewApi")
        protected void onPostExecute(Void result) {
            super.onPostExecute(result);
            Log.i("NewApiNewApiNewApi", "NewApiNewApi");
...
//                stageId = Integer.parseInt(Level_ParentID);
            ...
            case R.id.imagebtn_wenti:
                ...
                bundle_w.putInt("childClassTypeId", stageId);
            ...
            case R.id.left_ivBtn:
                if (httpUtils.isNetworkConnected(VerticalScreenActivity.this)) {
                    Log.i("左边上一课 --- > ", "" + OnLineBean.getBody().getTopinfo());
...
//                String Level_PKID  = OnLineBean.getBody().getTopinfo().getVID();
                        ...
                        Log.i("左边上一课 --- > ", "" + TopInfoType);
                        if ("1".equals(TopInfoType)) {
                            Intent intent = new Intent(VerticalScreenActivity.this, VerticalScreenNextLastActivity.class);
//                        Intent intent = getIntent();
                            ...
                            Toast.makeText(VerticalScreenActivity.this, "暂无课程", Toast.LENGTH_SHORT).show();
            ...
            case R.id.right_ivBtn:
                if (httpUtils.isNetworkConnected(VerticalScreenActivity.this)) {
                    Gson s = new Gson();
                    Log.i("右边下一课 --- > ", "" + s.toJson(OnLineBean.getBody().getDowninfo()).toString());
...
//                    String NextParentID = OnLineBean.getBody().getDowninfo().getParentLevelID()
                        String NextLevel_PKID = OnLineBean.getBody().getDowninfo().getLevel_PKID();
                        Log.i("右边下一课 --- > ", "" + DownInfoType);
...
//                          Intent intent = getIntent();
            ...
            case R.id.zsd_down_icon:
                //判断读写权限
                int permission = ActivityCompat.checkSelfPermission(VerticalScreenActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                if (permission != PackageManager.PERMISSION_GRANTED) {
                    // 无权限----
                    ActivityCompat.requestPermissions(VerticalScreenActivity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
                } else {
                    DownLoad();
                }
        ...
        if (VideoDownloadManager.getInstance().addClassIdTassk(ClassID, downClassName)) {
            ...
            if (VideoDownloadManager.getInstance().addStageIdTassk(ClassID, StageID, downStageName)) {
                if (!VideoDownloadManager.getInstance().addVideoTask(VID, ClassID, downlessonId, downlessonName, downsubjectId, downsubjectName, StageID, VPKID, "isStudy", studyKey, StageProblemStatus, StageNoteStatus, StageInformationStatus)) {
                    Toast.makeText(VerticalScreenActivity.this,
                    ...
                    Toast.makeText(VerticalScreenActivity.this, "成功添加进下载队列",
